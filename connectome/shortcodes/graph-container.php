...
<div id="connectome-graph-container">
  <span style="text-decoration:underline;color:red;">[The widget should be here,
    otherwise it's probably a problem with javascript or the widget scripts]</span>
</div>
